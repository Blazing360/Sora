 ...
 */
	...
	ignatius: function(target, room, user) {
		...
		if (!this.canBroadcast()) return;
		this.sendReplyBox('<a><font size= 6><center><b><i>∆ArthurZH∆</b></center></a><br />'+
